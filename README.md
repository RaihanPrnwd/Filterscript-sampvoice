...
- Hanya admin RCON (`IsPlayerAdmin`, wajib login RCON) yang bisa bicara di channel global (Z)
...
1. **Install plugin SAMPVOICE** oleh [CyberMor](https://github.com/CyberMor/sampvoice) (**WAJIB**)
2. Copy file `.amx` filterscript ini ke folder `filterscripts` server
3. Tambahkan nama filterscript ini (tanpa `.amx`) ke baris `filterscripts` di `server.cfg`
...
- Plugin SAMPVOICE oleh: **CyberMor**  
  [https://github.com/CyberMor/sampvoice](https://github.com/CyberMor/sampvoice)
